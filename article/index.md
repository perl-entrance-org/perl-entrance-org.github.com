...
<div id="homepage-update">
    <div class="row">
        ...
        <div class="listed column">
            <dl class="article">
                <dt>2019.12.22</dt>
                <dd>2020年01月 Perl入学式 秋開講 第3回の開講情報を追加しました (東京)</dd>
            </dl>
        </div>
    </div>
</div>
<div id="homepage-event">
    ...
    <div class="row">
        ...
        <div class="medium-6 large-6 columns next-event">
            <h4><i class="icon-leaf"></i> <a href="http://perl-entrance-tokyo.connpass.com/">Perl入学式 in東京</a> 秋開講 第3回</h4>
            <p class="date">
                2020年01月25日（土）
            </p>
            <!--
 ...
 -->
            ...
            <div class="read-more">
                <p class="event-page">
                    <a href="https://perl-entrance-tokyo.connpass.com/event/159284/" class="button radius expand" target="_blank">詳細はこちら!</a>
                </p>
            </div>
        </div>
        <!-- 大阪 -->
