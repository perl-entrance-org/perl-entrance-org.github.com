...
<section id="homepage-update">
    <div class="row">
        ...
        <div class="listed column">
            <dl class="article">
                <dt>2018.9.3</dt>
                <dd>2018年度9月 Perl入学式第3回の開講情報を追加しました (福岡)</dd>
                <dt>2018.8.18</dt>
                <dd>2018年度8月 Perl入学式第3回の開講情報を追加しました (沖縄)</dd>
                <dt>2018.8.4</dt>
                <dd>2018年度9月 Perl入学式第3回の開講情報を追加しました (大阪)</dd>
                <dt>2018.8.3</dt>
                <dd>2018年度9月 Perl入学式第2回の開講情報を追加しました (札幌)</dd>
            </dl>
        </div>
    </div>
</section>
...
<!--            <div class="notice">
            ...
            <div class="read-more">
                <p class="event-page">
                    <a href="https://perl-entrance-tokyo.connpass.com/event/96380/" class="button radius expand" target="_blank">詳細はこちら!</a>
                </p>
            </div>
        </div>
        ...
        <div class="medium-6 large-6 columns next-event">
            ...
            <div class="read-more">
                <p class="event-page">
                    <a href="http://perl-entrance-osaka.connpass.com/event/94076/" class="button radius expand" target="_blank">詳細はこちら!</a>
                </p>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="medium-6 large-6 columns next-event">
            ...
            <div class="read-more">
                <p class="event-page">
                    <a href="https://perl-entrance-okinawa.connpass.com/event/94299/" class="button radius expand" target="_blank">詳細はこちら!</a>
                </p>
            </div>
        </div>
    ...
    <div class="row">
        <div class="medium-6 large-6 columns next-event">
            <h4><i class="icon-leaf"></i> <a href="https://perl-entrance-sapporo.connpass.com/">Perl入学式 札幌</a> 第2回</h4>
            <p class="date">
                2018年9月15日（土）
            </p>
            <table class="detail">
                ...
                <tr>
                    <th>住所</th>
                    <td><a href="https://www.google.com/maps?ll=43.062429,141.341691&z=16&t=m&hl=ja&gl=US&mapclient=embed&q=%E3%80%92060-0002+%E5%8C%97%E6%B5%B7%E9%81%93%E6%9C%AD%E5%B9%8C%E5%B8%82%E4%B8%AD%E5%A4%AE%E5%8C%BA%E5%8C%97%EF%BC%92%E6%9D%A1%E8%A5%BF%EF%BC%91%EF%BC%90%E4%B8%81%E7%9B%AE%EF%BC%92%E2%88%92%EF%BC%97" target="_blank">北海道札幌市中央区北2条西10丁目2番地7</a></td>
                </tr>
            </table>
            <div class="read-more">
                <p class="event-page">
                    <a href="https://perl-entrance-sapporo.connpass.com/event/96858/" class="button radius expand" target="_blank">詳細はこちら!</a>
                </p>
            </div>
        </div>
