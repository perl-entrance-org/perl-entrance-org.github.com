...
<div id="homepage-update">
    <div class="row">
        ...
        <div class="listed column">
            <dl class="article">
                <dt>2021.11.27</dt>
                <dd>2021年度12月 Perl入学式 in 東京 第2回の日程を追加しました</dd>
                <dt>2021.11.26</dt>
                <dd>2021年度12月 Perl入学式オンライン 第5回の日程を追加しました</dd>
            </dl>
        </div>
    </div>
</div>
<div id="homepage-event">
    ...
    <div class="row">
        ...
        <div class="medium-6 large-6 columns next-event">
            <h4><i class="icon-leaf"></i> Perl入学式 オンライン 第5回</h4>
            <p class="date">
                2021年12月4日（土）
            </p>
            <!--
            ...
            <div class="read-more">
                <p class="event-page">
                    <a href="https://perl-entrance.connpass.com/event/232086/" class="button radius expand" target="_blank" data-region="online">詳細はこちら!</a>
                </p>
            </div>
        </div>
        <!-- 東京 -->
        <div class="medium-6 large-6 columns next-event">
            <h4><i class="icon-leaf"></i> Perl入学式 in東京 第2回</h4>
            <p class="date">
                2021年12月11日（土）
            </p>
            <!--
            ...
            <div class="read-more">
                <p class="event-page">
                    <a href="https://perl-entrance.connpass.com/event/232084/" class="button radius expand" target="_blank" data-region="tokyo">
詳細はこちら!</a>
                </p>
            </div>
        </div>
