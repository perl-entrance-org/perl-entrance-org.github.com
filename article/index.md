...
<div id="homepage-update">
    <div class="row">
        ...
        <div class="listed column">
            <dl class="article">
                <dt>2022.11.18</dt>
                <dd>2022年 12月 Perl入学式 in 大阪 第3回の日程を追加しました</dd>
                <dt>2022.6.17</dt>
...
<div id="homepage-event">
    ...
    <div class="row">
        ...
        <div class="medium-6 large-6 columns next-event">
            ...
            <div class="read-more">
                <p class="event-page">
                    <a href="https://perl-entrance.connpass.com/event/266248/" class="button radius expand" target="_blank" data-region="osaka">詳細はこちら!</a>
                </p>
            </div>
        </div>
