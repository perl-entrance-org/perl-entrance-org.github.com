    ...
    <div class="row">
        ...
        <div class="listed column">
            <dl class="article">
                ...
                <dt>2018.10.24</dt>
                <dd>2018年度11月 Perl入学式第3回の開講情報を追加しました (札幌)</dd>
                <dt>2018.10.9</dt>
...
<!--            <div class="notice">
    ...
    <div class="row">
        <div class="medium-6 large-6 columns next-event">
            ...
            <div class="read-more">
                <p class="event-page">
                    <a href="https://perl-entrance-okinawa.connpass.com/event/106627/" class="button radius expand" target="_blank">詳細はこちら!</a>
                </p>
            </div>
        </div>
