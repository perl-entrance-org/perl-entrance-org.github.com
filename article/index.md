    ...
    <div class="row">
        ...
        <div class="listed column">
            <dl class="article">
                ...
                <dt>2017.10.7</dt>
                <dd>2017年度11月 Perl入学式第4回の開講情報を追加しました (大阪)</dd>
                <dt>2017.09.03</dt>
...
<!--            <div class="notice">
            ...
            <div class="read-more">
                <p class="event-page">
                    <a href="https://perl-entrance-tokyo.connpass.com/event/74837/" class="button radius expand" target="_blank">詳細はこちら!</a>
                </p>
            </div>
        </div>
        ...
        <div class="medium-6 large-6 columns next-event">
            ...
            <div class="read-more">
                <p class="event-page">
                    <a href="http://perl-entrance-osaka.connpass.com/event/68935/" class="button radius expand" target="_blank">詳細はこちら!</a>
                </p>
            </div>
        </div>
    </div>
