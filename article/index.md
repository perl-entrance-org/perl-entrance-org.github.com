    ...
    <div class="row">
        ...
        <div class="listed column">
            <dl class="article">
                ...
                <dt>2018.1.27</dt>
                <dd>2017年度1月 Perl入学式第3回の開講情報を追加しました (東京)</dd>
                <dt>2018.1.10</dt>
                <dd>2017年度2月 Perl入学式第5回の開講情報を追加しました (大阪)</dd>
            </dl>
        </div>
    </div>
</section>
...
<section id="homepage-event">
    ...
    <div class="row">
        <div class="medium-6 large-6 columns next-event">
            <h4><i class="icon-leaf"></i> <a href="http://perl-entrance-tokyo.connpass.com/">Perl入学式 in東京</a> 第4回＆第5回</h4>
            <p class="date">
                2018年3月10日（土）
            </p>
<!--            <div class="notice">
            ...
            <div class="read-more">
                <p class="event-page">
                    <a href="https://perl-entrance-tokyo.connpass.com/event/80238/" class="button radius expand" target="_blank">詳細はこちら!</a>
                </p>
            </div>
        </div>
        ...
        <div class="medium-6 large-6 columns next-event">
            ...
            <div class="read-more">
                <p class="event-page">
                    <a href="http://perl-entrance-osaka.connpass.com/event/76463/" class="button radius expand" target="_blank">詳細はこちら!</a>
                </p>
            </div>
        </div>
    </div>
