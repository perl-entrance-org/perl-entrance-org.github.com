...
<div id="homepage-update">
    <div class="row">
        ...
        <div class="listed column">
            <dl class="article">
                <dt>2023.1.26</dt>
                <dd>2023年 1月 Perl入学式 in 大阪第5回の日程を追加しました</dd>
                <dt>2022.6.17</dt>
...
<div id="homepage-event">
    ...
    <div class="row">
        ...
        <div class="medium-6 large-6 columns next-event">
            <h4><i class="icon-leaf"></i> Perl入学式 in大阪第5回</h4>
            <p class="date" data-date="2023-02-18T00:00:00+09:00">
                2023年2月18日（土）
            </p>
            <!--
            <div class="notice">
            ...
            <div class="read-more">
                <p class="event-page">
                    <a href="https://perl-entrance.connpass.com/event/273487/" class="button radius expand" target="_blank" data-region="osaka">詳細はこちら!</a>
                </p>
            </div>
        </div>
