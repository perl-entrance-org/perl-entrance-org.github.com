...
<section id="homepage-event">
    ...
    <div class="row">
        <div class="medium-12 columns">
            <p>
                台風19号が関東地方に接近しており, 開催日となる13日は非常に強い雨や風に見舞われる可能性が出ております.<br>
                会場への移動が困難になることが予想されるため, 開催日当日である13日の午前10時段階で, 台風が原因となる大雨警報, 暴風警報, 洪水警報が東京23区に発令されている場合, 13日の開催を中止とさせて頂きます.<br>
                この場合, 代替となる講義を11月中旬に開催するよう調整させて頂きます.
            </p>

            <p>
                13日に開講するか否かは, 上記の基準に基づいて, 改めて当日13日の午前10時に, Zusaarのメッセージ及び公式Twitter(@Perl_Entrance)にて告知させて頂きます.<br>
