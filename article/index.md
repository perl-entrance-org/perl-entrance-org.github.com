...
<section id="homepage-update">
    <div class="row">
        ...
        <div class="listed column">
            <dl class="article">
                <dt>2018.7.21</dt>
                <dd>2018年度7月 Perl入学式第3回(沖縄)は台風の為延期しました</dd>
                <dt>2018.7.13</dt>
                <dd>2018年度7月 Perl入学式第3回の開講情報を追加しました (沖縄)</dd>
                <dt>2018.6.19</dt>
                <dd>2018年度7月 Perl入学式第4回の開講情報を追加しました (東京)</dd>
            </dl>
        </div>
    </div>
</section>
...
<!--            <div class="notice">
            ...
            <div class="read-more">
                <p class="event-page">
                    <a href="https://perl-entrance-tokyo.connpass.com/event/91421/" class="button radius expand" target="_blank">詳細はこちら!</a>
                </p>
            </div>
        </div>
    ...
    <div class="row">
        <div class="medium-6 large-6 columns next-event">
            ...
            <div class="read-more">
                <p class="event-page">
                    <a href="https://perl-entrance-okinawa.connpass.com/event/90507/" class="button radius expand" target="_blank">詳細はこちら!</a>
                </p>
            </div>
        </div>
