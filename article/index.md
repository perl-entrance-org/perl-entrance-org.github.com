...
<section id="homepage-update">
    <div class="row">
        ...
        <div class="listed column">
            <dl class="article">
                <dt>2018.12.10</dt>
                <dd>2018年度12月 Perl入学式第4回の開講情報を追加しました (沖縄)</dd>
                <dt>2018.11.7</dt>
                <dd>2018年度12月 Perl入学式第2回の開講情報を追加しました (東京)</dd>
                <dt>2018.10.30</dt>
                <dd>2018年度11月 Perl入学式第4回の開講情報を追加しました (沖縄)</dd>
            </dl>
        </div>
    </div>
</section>
...
<!--            <div class="notice">
            ...
            <div class="read-more">
                <p class="event-page">
                    <a href="https://perl-entrance-tokyo.connpass.com/event/108071/" class="button radius expand" target="_blank">詳細はこちら!</a>
                </p>
            </div>
        </div>
    ...
    <div class="row">
        <div class="medium-6 large-6 columns next-event">
            ...
            <div class="read-more">
                <p class="event-page">
                    <a href="https://perl-entrance-okinawa.connpass.com/event/112521/" class="button radius expand" target="_blank">詳細はこちら!</a>
                </p>
            </div>
        </div>
