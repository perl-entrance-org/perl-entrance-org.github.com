...
<section id="homepage-update">
    <div class="row">
        ...
        <div class="listed column">
            <dl class="article">
                <dt>2018.10.9</dt>
                <dd>2018年度10月 Perl入学式第1回の開講情報を追加しました (東京)</dd>
                <dt>2018.9.28</dt>
                <dd>2018年度11月 Perl入学式第4回の開講情報を追加しました (大阪)</dd>
                <dt>2018.9.3</dt>
...
<!--            <div class="notice">
            ...
            <div class="read-more">
                <p class="event-page">
                    <a href="https://perl-entrance-tokyo.connpass.com/event/104368/" class="button radius expand" target="_blank">詳細はこちら!</a>
                </p>
            </div>
        </div>
        ...
        <div class="medium-6 large-6 columns next-event">
            ...
            <div class="read-more">
                <p class="event-page">
                    <a href="http://perl-entrance-osaka.connpass.com/event/102533/" class="button radius expand" target="_blank">詳細はこちら!</a>
                </p>
            </div>
        </div>
    </div>
