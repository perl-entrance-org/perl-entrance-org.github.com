    ...
    <div class="row">
        ...
        <div class="listed column">
            <dl class="article">
                ...
                <dt>2017.06.16</dt>
                <dd>2017年度7月 Perl入学式第4回の開講情報を追加しました (沖縄)</dd>
                <dd>2017年度7月 Perl入学式第3回の開講情報を追加しました (札幌)
                </dd>
                <dt>2017.06.15</dt>
                <dd>2017年度7月 Perl入学式第2回の開講情報を追加しました (大阪)</dd>
                <dd>2017年度7月 Perl入学式第4回の開講情報を追加しました (東京)</dd>
            </dl>
        </div>
    </div>
</section>
...
<section id="homepage-event">
    ...
    <div class="row">
        <div class="medium-6 large-6 columns next-event">
            ...
            <div class="read-more">
                <p class="event-page">
                    <a href="https://perl-entrance-tokyo.connpass.com/event/59983/" class="button radius expand" target="_blank">詳細はこちら!</a>
                </p>
            </div>
        </div>
