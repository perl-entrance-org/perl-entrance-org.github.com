    ...
    <div class="row">
        ...
        <div class="listed column">
            <dl class="article">
                ...
                <dt>2021.5.9</dt>
                <dd>2021年度5月 Perl入学式オンライン 第2回の開講情報を追加しました</dd>
            </dl>
        </div>
    </div>
</div>
<div id="homepage-event">
    ...
    <div class="row">
        ...
        <div class="medium-6 large-6 columns next-event">
            ...
            <div class="read-more">
                <p class="event-page">
                    <a href="https://perl-entrance.connpass.com/event/212840/" class="button radius expand" target="_blank" data-region="online">詳細はこちら!</a>
                </p>
            </div>
        </div>
    </div>
