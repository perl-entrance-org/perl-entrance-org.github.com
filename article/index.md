    ...
    <div class="row">
        ...
        <div class="listed column">
            <dl class="article">
                ...
                <dt>2018.4.23</dt>
                <dd>2017年度4月 Perl入学式第2回の開講情報を追加しました (東京)</dd>
                <dt>2018.4.16</dt>
                <dd>2018年度5月 Perl入学式第1回の開講情報を追加しました (沖縄)</dd>
            </dl>
        </div>
    </div>
</section>
...
<!--            <div class="notice">
            ...
            <div class="read-more">
                <p class="event-page">
                    <a href="https://perl-entrance-tokyo.connpass.com/event/86154/" class="button radius expand" target="_blank">詳細はこちら!</a>
                </p>
            </div>
        </div>
        ...
        <div class="medium-6 large-6 columns next-event">
            ...
            <div class="read-more">
                <p class="event-page">
                    <a href="http://perl-entrance-osaka.connpass.com/event/83293/" class="button radius expand" target="_blank">詳細はこちら!</a>
                </p>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="medium-6 large-6 columns next-event">
            ...
            <div class="read-more">
                <p class="event-page">
                    <a href="https://perl-entrance-okinawa.connpass.com/event/86372/" class="button radius expand" target="_blank">詳細はこちら!</a>
                </p>
            </div>
        </div>
